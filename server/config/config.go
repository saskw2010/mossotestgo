...
func initViper() (Constants, error) {
	...
	if os.Getenv("ENVIRONMENT") == "DOCKER" {
		viper.SetConfigName("mossotest_docker.config") // Configuration fileName without the .TOML or .YAML extension
	} else {
		viper.SetConfigName("mossotest.config") // Configuration fileName without the .TOML or .YAML extension
	}
